...
PowerShell toolkit that benchmarks and qualifies local LLMs on Batmobile (RTX 4070 Ti Super 16 GB) through LM Studio's API at `http://192.168.0.112:1234`. Not an application — no build, package manager, or test framework. Operating details live in [CLAUDE.md](CLAUDE.md); evidence and decision record in [BATMOBILE_LM_STUDIO_HANDOFF.md](BATMOBILE_LM_STUDIO_HANDOFF.md).
