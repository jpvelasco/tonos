...
LM Studio endpoint: `http://192.168.0.112:1234/v1`
...
- Active config: `C:\Users\jpvel\.config\opencode\opencode.json`
- The active path is a symbolic link to:
  `F:\source\dotfiles\opencode\opencode.json`
...
- Batmobile provider: `http://192.168.0.112:1234/v1`
- Configured Batmobile models:
  - `qwen3.6-35b-a3b`
    - Context: 65,536
  ...
  - `google/gemma-4-12b-qat`
    - Context: 65,536
    - Maximum output: 16,384
- Batwing remains configured separately:
  - Endpoint: `http://192.168.0.131:8082/v1`
...
- Config: `C:\Users\jpvel\.grok\config.toml`
- Default remains `batwing-coder`.
- Available local aliases:
  - `batwing-coder`
  - `batmobile-qwen36`
  - `batmobile-gemma4`
- Removed stale or broken aliases:
  - `batmobile-qwen3-coder`
  - Qwen3.5 9B
  - Qwen2.5 Coder
  - GPT-OSS
  - Nemotron
...
|---|---:|---:|
| Batwing coder | `OK` | 12.3 s |
| Batmobile Gemma 4 | `OK` | 21.6 s |
| Batmobile Qwen3.6 | `OK` | 164.4 s |
...
`C:\Users\jpvel\.lmstudio\.internal\cli-pref.json`
...
- `C:\Users\jpvel\.config\opencode\opencode.json.backup-20260703-124632`
- `C:\Users\jpvel\.grok\config.toml.backup-20260703-124632`
...
A usable Batmobile default should:
