# Batcave Coder Tuner - Clean PS7 Version
$PromptFile = "nyxtest_prompt.txt"
$TestPrompt = @"
nyx (github.com/jpvelasco/nyx) is a Go CLI for declarative homelab network validation and drift detection. You declare networks, VPNs, policies, and assertions in YAML; it runs live checks (primarily via nmap + platform system commands, plus Omada SDN and OPNsense integration) and produces normalized, structured results.
...
Write-Host "🚀 Batcave Coder Tuner (PS7)" -ForegroundColor Cyan
