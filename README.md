...
Generated results are intentionally ignored. See [CLAUDE.md](CLAUDE.md) for operating details and [BATMOBILE_LM_STUDIO_HANDOFF.md](BATMOBILE_LM_STUDIO_HANDOFF.md) for the evidence and decision record.
